...
async function search(req, res) {
  ...
  const { data, itemCount, message, error } = await JobMap.searchJob(
    params,
    length,
    start,
    sorting
...
async function getJobOfCompany(req, res) {
  ...
  const { data, itemCount, message, error } = await JobMap.getJobOfCompany(
    id,
    length,
    start,
    status
...
async function save(req, res) {
  ...
  const { success, data, message, error } = await JobMap.updateJobByID(
    id,
    updateData
  );
